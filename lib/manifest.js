  ...
  var BRAND = {
    ...
    products: [
      ...
      },
      {
        ...
        // Mismo caso que cera-deluxe-matte-pasta-fuchsia: envase más chico
        // en la foto original, compensado con zoom vía CSS.
        photoZoom: true,
        category: "ceras",
        brand: "ROQVEL",
      ...
      },
      {
        ...
        // El envase se ve más chico en esta foto que en el resto de la
        // grilla (mismo problema de encuadre en la toma original) — se
        // compensa con zoom vía CSS (.shop-card-visual-img--zoom).
        photoZoom: true,
        category: "ceras",
        brand: "ROQVEL",
