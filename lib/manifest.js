...
(function () {
  ...
  var BRAND = {
    ...
    /* ---------- Productos ----------
       Campos opcionales que activan elementos del grid de la home
       (main.js los lee en slideHTML) — no inventar valores, dejar el
       campo afuera si el dato real todavía no existe:
         - rating: { value: 4.8, count: 12 }  → muestra estrellas +
           (N) en la tarjeta. Debe ser un promedio de reseñas reales
           de ESE producto (no la reseña general de la barbería).
         - isNew: true  → si el producto no tiene rating todavía,
           muestra el badge "Nuevo" en vez de estrellas. Usar solo
           para lanzamientos recientes reales, no dejarlo puesto
           indefinidamente.
         - originalPriceCLP: 12000  → si es mayor a priceCLP, la
           tarjeta muestra precio tachado + "Ahorra X%" (calculado
           solo, nunca hardcodear el %). Para packs por mayor reales,
    ...
    products: [
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-deluxe-matte-wax-peony-info.webp?v=3",
        category: "ceras",
        brand: "ROQVEL",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-deluxe-matte-pasta-fuchsia-info.webp?v=3",
        category: "ceras",
        brand: "ROQVEL",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-aqua-wax-orange-info.webp?v=2",
        category: "ceras",
        brand: "ROQVEL",
        ...
        price: "$10.000",
        priceCLP: 10000,
        rating: { value: 5.0, count: 3 }, // mismo dato real que ya se muestra en su ficha (pdp-rating-row / JSON-LD)
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-aqua-wax-red-info.webp?v=3",
        category: "ceras",
        brand: "ROQVEL",
        name: "Cera Aqua Wax con brillo",
        sub: "Red",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-aqua-wax-blue-info.webp?v=2",
        category: "ceras",
        brand: "ROQVEL",
        name: "Cera Aqua Wax con brillo",
        sub: "Blue",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-spider-wax-purple-info.webp?v=3",
        category: "ceras",
        brand: "ROQVEL",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-matte-wax-brown-info.webp?v=4",
        category: "ceras",
        brand: "ROQVEL",
        name: "Cera Matte Wax",
        sub: "Brown",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-cream-wax-fiber-effect-info.webp?v=2",
        category: "ceras",
        brand: "ROQVEL",
        name: "Cera Cream Wax",
        sub: "Fiber Effect",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/cera-matte-pomade-green-info.webp?v=3",
        category: "ceras",
        brand: "ROQVEL",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/curl-cream-rolda-2.webp",
        category: "cabello",
        brand: "Rolda",
        name: "Curl Cream",
      ...
      },
      {
        ...
        photoHover: "assets/img/products/aceite-barba-maxcare-2.webp",
        category: "barba",
        brand: "MaxCare",
    ...
    /* ---------- Franja de confianza del footer (medios de pago + legales) ----
       Referencia de lo que HOY está habilitado/mostrado en
       .footer-trust (todas las páginas) — el HTML de esa franja es
       estático (mismo criterio que el resto del footer/nav de este
       proyecto: sin build step, sin templating por JS), así que
       agregar/quitar un ítem acá NO lo cambia solo en la página; sirve
       como checklist central antes de editar el HTML a mano.
         - payments: medios de pago realmente procesados hoy — todo
           pasa por MercadoPago Checkout Pro (Visa/Mastercard/Webpay/
           transferencia). No agregar un logo nuevo sin habilitar antes
           ese medio de pago de verdad.
         - legalLinks: página + estado real de cada una. "pending"
           = la ruta existe y está linkeada, pero el contenido legal
           todavía no se redactó (no inventar cláusulas legales).
       Los logos de Visa/Mastercard/Mercado Pago son recreaciones
       vectoriales propias en los colores oficiales de cada marca (el
       proyecto no tenía los archivos de logo originales y no hay forma
       de descargarlos automáticamente) — si en algún momento consiguen
       los assets oficiales, reemplazar los <symbol id="icon-visa/
       icon-mastercard/icon-mercadopago"> del sprite SVG de cada página. */
    footerTrust: {
      payments: ["Visa", "Mastercard", "Mercado Pago"],
      legalLinks: [
        { label: "Términos y condiciones", href: "terminos-condiciones.html", status: "live" },
        { label: "Privacidad", href: "politica-privacidad.html", status: "live" },
        { label: "Envíos", href: "politica-envios.html", status: "live" },
        { label: "Cambios y devoluciones", href: "cambios-devoluciones.html", status: "live" },
        { label: "Reembolsos", href: "politica-reembolsos.html", status: "live" },
        { label: "Contacto", href: "index.html#contacto", status: "live" },
      ],
    },
