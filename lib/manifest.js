...
(function () {
  ...
  var BRAND = {
    ...
    /* ---------- Productos ----------
       Campos opcionales que activan elementos de las tarjetas de
       producto (main.js los lee en productCardHTML) — no inventar
       valores, dejar el campo afuera si el dato real no existe:
         - featured: true  → el producto entra en "Productos
           destacados" de la home (index.html#productos). Solo se
           consideran los de category "ceras"/"polvo" aunque el flag
           esté en otro. Para agregar/quitar un producto de la home
           en el futuro, basta con mover este flag — no hay que tocar
           HTML/CSS/JS. El catálogo completo (productos.html) siempre
           muestra TODOS los productos sin filtrar por este flag.
         ...
         - originalPriceCLP: 12000  → si es mayor a priceCLP, la
           tarjeta muestra precio anterior tachado + precio actual.
           Es el precio de referencia real que definió el negocio, no
           un descuento inventado por la web. */
    products: [
      {
        id: "polvo-textura-09",
        icon: "jar",
