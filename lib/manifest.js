...
(function () {
  ...
  window.__BRAND__ = {
    ...
    /* ---------- Tienda online (carrito + pago con MercadoPago) ----------
       flatFee: costo fijo de despacho a domicilio, en pesos chilenos (CLP).
       Se suma al total del carrito solo si el cliente elige "Despacho a domicilio"
       en el formulario de pago. Cámbialo aquí y se actualiza en todo el sitio. */
    shipping: {
      flatFee: 2500,
      currency: "CLP",
      freeFrom: 0, // si quieres despacho gratis sobre cierto monto, pon el monto aquí (0 = desactivado)
    },
    mercadopago: {
      apiEndpoint: "/api/create-preference",
    },

    /* ---------- Reseñas de Google (5,0 · 29 reseñas) ---------- */
    reviews: [
